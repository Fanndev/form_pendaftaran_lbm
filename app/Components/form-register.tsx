...
export default function Form() {
  ...
  const handleSignatureUpload = (
    ...
    if (file) {
      ...
      reader.onloadend = () => {
        setTandaTangan(reader.result as string);
      };
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const signatureText = tandaTangan
      ? 'Tanda tangan telah diunggah.'
      : 'Tanda tangan tidak diunggah.';
  ...
  return (
    <div className="bg-white p-8 rounded-xl shadow-2xl max-w-4xl mx-auto border-t-8 border-blue-500">
      <h1 className="text-3xl font-extrabold text-center text-gray-800 mb-2">
        Formulir Pendaftaran Program LBM
      </h1>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                required
                className="mt-1 block text-gray-700 w-full p-3 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500"
              />
            </div>
            <div>
              <label
        ...
        <div className="space-y-4 pt-6">
          ...
          <div>
            ...
            >
              ...
              <option value="English for Kids (Usia Dini)">
                English for Kids (Usia Dini)
              </option>
              <option value="English for Children">English for Children</option>
              <option value="English for Basic/Teenagers">
                English for Basic/Teenagers
              </option>
              <option value="Indonesian and CCU">Indonesian and CCU</option>
              <option value="Test Preparation (TOEFL, TOEIC, IELTS & UKBI)">
                Test Preparation (TOEFL, TOEIC, IELTS &amp; UKBI)
              </option>
              <option value="ESP (English for Specific Purposes)">
                ESP (English for Specific Purposes)
              </option>
              <option value="Bimbel Matematika">Bimbel Matematika</option>
              <option value="Bimbel CALISTUNG (Baca, Tulis, dan Hitung)">
                Bimbel CALISTUNG (Baca, Tulis, dan Hitung)
              </option>
        ...
        <div className="pt-6">
          ...
          <p className="text-gray-600 text-sm mt-4 italic">
            Silakan unggah file gambar tanda tangan Anda. Catatan: Tanda tangan
            akan dikirim sebagai teks biasa ke WhatsApp.
          </p>

          <div className="mt-4">
            <label
              htmlFor="tandaTanganFile"
              className="block text-sm font-medium text-gray-600"
            >
              Unggah Tanda Tangan
            </label>
            <input
              ...
              className="mt-1 block text-gray-700 w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100"
            />
            {tandaTangan && (
              <div className="mt-4">
                ...
                <Image
                  ...
                  width={200}
                  height={100}
                  className="mt-2 max-w-xs border border-gray-300 rounded-lg"
                />
              </div>
            )}
          </div>
        ...
        <button
          type="submit"
          className="w-full bg-green-500 text-white font-bold py-3 px-6 rounded-lg hover:bg-green-600 transition-colors duration-300 shadow-lg"
        >
          Kirim via WhatsApp
        </button>
      </form>
